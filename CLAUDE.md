...
## Frontend Interface Option

In addition to the direct processing method described above, a web interface is available for submitting search requests. This provides an alternative way to access the search functionality with a user-friendly web form.

For details on using the web interface, see `frontend/README.md`.
